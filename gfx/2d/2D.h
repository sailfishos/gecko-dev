...
struct DrawOptions {
  ...
  CompositionOp
      mCompositionOp; /**< The operator that indicates how the source and
...
struct DrawSurfaceOptions {
  ...
  SamplingBounds
      mSamplingBounds; /**< This indicates whether the implementation is
...
class DataSourceSurface : public SourceSurface {
 public:
  ...
  DataSourceSurface() : mIsMapped(false) {}
   ...
   */
  virtual int32_t Invalidations() const { return -1; }
...
class GFX2D_API Factory {
 ...
 public:
   ...
   */
  static already_AddRefed<ScaledFont> CreateScaledFontWithCairo(
      const NativeFont &aNativeFont, const RefPtr<UnscaledFont> &aUnscaledFont,
