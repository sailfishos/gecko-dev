...
Patch1:     0001-PATCH-01-67-Add-symlink-to-embedlite.-JB-52893.patch
Patch2:     0002-PATCH-02-67-Bring-back-Qt-layer.-JB-50505.patch
Patch3:     0003-PATCH-03-67-Fix-embedlite-building.-JB-50505.patch
Patch4:     0004-PATCH-04-67-Read-rustc-host-from-environment.-JB-530.patch
Patch5:     0005-PATCH-05-67-Provide-checkbox-radio-renderer-for-Sail.patch
Patch6:     0006-PATCH-06-67-Fix-GLContextProvider-defines.patch
Patch7:     0007-PATCH-08-67-Cleanup-static-components-definitions.-J.patch
Patch8:     0008-PATCH-09-67-Reduce-Rust-build-requirements.patch
Patch9:     0009-PATCH-12-67-Backport-Embed-MessageLoop-contructor-ba.patch
Patch10:    0010-PATCH-13-67-Allow-compositor-specializations-to-over.patch
Patch11:    0011-PATCH-20-67-Allow-gen_last_modified.py-to-complete.patch
Patch12:    0012-PATCH-21-67-Force-to-build-mozglue-and-xpcomglue-sta.patch
Patch13:    0013-PATCH-22-67-Revert-Bug-445128-Stop-putting-the-versi.patch
Patch14:    0014-PATCH-23-67-Revert-Bug-1427455-Remove-unused-variabl.patch
Patch15:    0015-PATCH-24-67-Revert-Bug-1333826-Remove-SDK_FILES-SDK_.patch
Patch16:    0016-PATCH-25-67-Restore-SDK-installation-support.patch
Patch17:    0017-PATCH-26-67-Revert-Bug-1333826-Remove-a-few-referenc.patch
Patch18:    0018-PATCH-27-67-Introduce-EmbedInitGlue-to-the-mozglue.-.patch
Patch19:    0019-PATCH-28-67-Split-namespace-into-two-blocks.patch
Patch20:    0020-PATCH-29-67-Do-not-create-CreateFallbackSurface.-JB-.patch
Patch21:    0021-PATCH-30-67-Make-PresShell-SetIsActive-public.patch
Patch22:    0022-PATCH-31-67-Drop-swap_buffers_with_damage-extension-.patch
Patch23:    0023-PATCH-33-67-Fix-gfxPlatform-AsyncPanZoomEnabled-for-.patch
Patch24:    0024-PATCH-35-67-Allow-file-scheme-when-loading-OpenSearc.patch
Patch25:    0025-PATCH-36-67-Add-and-adjust-embedlite-static-prefs.patch
Patch26:    0026-PATCH-37-67-Disable-SessionStore-functionality.patch
Patch27:    0027-PATCH-38-67-Prevent-errors-from-DownloadPrompter.patch
Patch28:    0028-PATCH-39-67-Restore-fallback-NotifyDidPaint-timer-fo.patch
Patch29:    0029-PATCH-42-67-Disable-desktop-sharing-for-EmbedLite.patch
Patch30:    0030-PATCH-43-67-Implement-video-capture-module.-JB-53982.patch
Patch31:    0031-PATCH-44-67-Integrate-geckocamera-with-WebRTC-builds.patch
Patch32:    0032-PATCH-45-67-Drop-AudioPlayback-messages-if-no-embedd.patch
Patch33:    0033-PATCH-46-67-Get-ContentFrameMessageManager-via-nsIDo.patch
Patch34:    0034-PATCH-48-67-Route-EmbedLite-login-prompts-to-their-w.patch
Patch35:    0035-PATCH-49-67-Follow-ambience-for-prefers-color-scheme.patch
Patch36:    0036-PATCH-51-67-Fix-content-action-integration-to-work.-.patch
Patch37:    0037-PATCH-52-67-Enable-fullscreen-for-EmbedLite.-Fixes-J.patch
Patch38:    0038-PATCH-53-67-Force-use-of-mobile-video-controls.-JB-5.patch
Patch39:    0039-Add-a-video-decoder-based-on-gecko-camera.-JB-56755.patch
Patch40:    0040-PATCH-56-67-Ensure-audio-continues-when-screen-is-lo.patch
Patch41:    0041-PATCH-57-67-Delete-startupCache-if-it-s-stale.patch
Patch42:    0042-PATCH-58-67-Hardcode-loopback-address-for-profile-lo.patch
Patch43:    0043-PATCH-59-67-Start-using-user-agent-builder.-JB-52068.patch
Patch44:    0044-PATCH-60-67-Disallow-page-zooming-for-a-fixed-meta-v.patch
Patch45:    0045-PATCH-61-67-Add-a-preference-to-bypass-CORS-checks.patch
Patch46:    0046-PATCH-62-67-Get-the-12-24-hour-time-format-from-dcon.patch
Patch47:    0047-PATCH-65-67-Separate-the-bindgen-runtime-libclang-pa.patch
Patch48:    0048-sailfishos-embedlite-Present-offscreen-WebRender-fra.patch
Patch49:    0049-Restore-EmbedLite-native-prompt-dialogs.patch
Patch50:    0050-PATCH-Guard-media-suspend-paths-before-initializatio.patch
Patch51:    0051-PATCH-71-71-Allow-disabling-default-protocol-handler.patch
Patch52:    0052-Fix-EmbedLite-toolkit-error-pages.patch
Patch53:    0053-Use-EmbedLite-helper-app-dialog-static-registration.patch
Patch54:    0054-sailfishos-search-Initialize-application-engines.patch
Patch55:    0055-Dispatch-MDSM-initialization-without-tail-dispatch.patch
Patch56:    0056-Preload-autoplay-metadata-before-inaudible-check.patch
Patch57:    0057-Fix-Qt-checkbox-and-radio-rendering.patch
Patch58:    0058-Keep-about-support-snapshot-resilient-in-EmbedLite.patch
Patch59:    0059-sailfishos-sqlite-Use-the-platform-SQLite-library.patch
Patch60:    0060-sailfishos-egl-Support-Qt-s-EGL-display-on-Mesa.patch
Patch61:    0061-sailfishos-webrender-Support-software-rendering-on-E.patch
Patch62:    0062-sailfishos-egl-Add-safe-Qt-display-fallback-for-hybr.patch
Patch63:    0063-sailfishos-neterror-Keep-certificate-controls-above-.patch
Patch64:    0064-sailfishos-prompt-Allow-EmbedLite-confirmEx-dialogs.patch
Patch65:    0065-sailfishos-build-Fix-Qt-compilation.patch
Patch66:    0066-sailfishos-media-Keep-PipeWire-integration-GTK-only.patch
Patch67:    0067-sailfishos-webgpu-Keep-DMA-BUF-textures-GTK-only.patch
Patch68:    0068-sailfishos-build-Allow-disabling-release-Rust-LTO.patch
Patch69:    0069-sailfishos-build-Avoid-generator-fork-pools-under-QE.patch
Patch70:    0070-sailfishos-build-Keep-desktop-services-GTK-only-on-Q.patch
Patch71:    0071-sailfishos-layout-Use-Linux-RFP-system-font-on-Qt.patch
Patch72:    0072-sailfishos-widget-Allow-custom-puppet-child-allocati.patch
Patch73:    0073-sailfishos-icu-Remove-obsolete-libstdc-type_info-wor.patch
Patch74:    0074-sailfishos-egl-Define-platform-image-import-targets.patch
Patch75:    0075-sailfishos-embedlite-Export-embedding-session-APIs.patch
Patch76:    0076-sailfishos-webrender-Flush-invalidated-frames-atomic.patch
Patch77:    0077-sailfishos-egl-Manage-platform-frame-consumer-fences.patch
Patch78:    0078-sailfishos-build-Expand-mozglue-into-programs.patch
Patch79:    0079-sailfishos-qt-Use-minimal-QPA-for-headless-children.patch
Patch80:    0080-sailfishos-apz-Dispatch-remote-taps-to-Gecko-main.patch
Patch81:    0081-sailfishos-embedlite-Bind-compositors-to-their-windo.patch
Patch82:    0082-sailfishos-embedlite-Expose-received-message-values.patch
Patch83:    0083-sailfishos-xre-Enable-XDG-profile-paths-on-Qt.patch
Patch84:    0084-sailfishos-embedlite-Handle-in-process-history-trave.patch
...
# Stage the host tooling's elf32-i386 libclang inside the arm target, JB#55042.
# GCONV_PATH identifies the active SB2 tooling; native builders use /usr/lib or
# fall back to it. Include libLLVM for host build scripts running under target
# mapping, deriving its exact SONAME from libclang. Use a dedicated
# directory so stale libraries from an incremental build cannot be selected.
rm -rf "%BUILD_DIR"/bindgen-host-libs
mkdir -p "%BUILD_DIR"/bindgen-host-libs
HOST_LIBDIR="${GCONV_PATH%%%%:*}"
HOST_LIBDIR="${HOST_LIBDIR%%/gconv}"
if [ ! -d "$HOST_LIBDIR" ]; then
    HOST_LIBDIR=/usr/lib
fi
LIBCLANG_SO="$(SBOX_DISABLE_MAPPING=1 sh -c 'ls -1 "$1"/libclang.so.*' sh "$HOST_LIBDIR" | sort -V | tail -n1)"
test -n "$LIBCLANG_SO"
