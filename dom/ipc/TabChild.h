 ...
 public:
  ...
  NS_IMETHOD SendSyncMessage(const nsAString& aMessageName,
    ...
    return mMessageManager ? mMessageManager->SendSyncMessage(
                                 aMessageName, aObject, aRemote, aPrincipal,
                                 aCx, aArgc, aRetval)
  ...
  NS_IMETHOD SendRpcMessage(const nsAString& aMessageName,
                            ...
                            uint8_t aArgc,
                            JS::MutableHandle<JS::Value> aRetval) override {
    return mMessageManager ? mMessageManager->SendRpcMessage(
                                 aMessageName, aObject, aRemote, aPrincipal,
                                 aCx, aArgc, aRetval)
                           : NS_ERROR_NULL_POINTER;
  }
...
class TabChild final : public TabChildBase,
 ...
 public:
  ...
  virtual mozilla::ipc::IPCResult RecvInitRendering(
      ...
      const bool& aLayersConnected, PRenderFrameChild* aRenderFrame) override;
  ...
  void DidComposite(uint64_t aTransactionId, const TimeStamp& aCompositeStart,
  ...
  void ZoomToRect(const uint32_t& aPresShellId,
                  const FrameMetrics::ViewID& aViewId, const CSSRect& aRect,
 ...
 protected:
  ...
  virtual mozilla::ipc::IPCResult RecvRenderLayers(
      const bool& aEnabled, const uint64_t& aLayerObserverEpoch) override;
