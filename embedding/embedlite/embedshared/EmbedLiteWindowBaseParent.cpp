...
EmbedLiteWindowBaseParent::EmbedLiteWindowBaseParent(const uint16_t &width, const uint16_t &height, const uint32_t &id, EmbedLiteWindowListener *aListener)
  : mId(id)
  , mListener(aListener)
  , mWindow(nullptr)
  , mCompositor(nullptr)
...
uint32_t EmbedLiteWindowBaseParent::Current()
{
